...
/**
 * @title hodlToken
 * HODLers can later distribute these tokens as they wish using `transfer` and other
...
contract hodlToken is Pausable, StandardToken {
  ...
  // TODO ADDED 10/17 TO SAVE 20% TOKENS FOR TEAM
  uint256 public purchasableTokens = INITIAL_SUPPLY - INITIAL_SUPPLY/5;

  uint256 public RATE = 200;

  // TODO ADDED 10/17 TO SET START AND END BLOCKS FOR ICO
